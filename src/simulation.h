...
/*! \class Simulation
  ...
  It then runs the simulation and prints the results on \ref terminal and/or \ref file.
 */
...
/*! 
  ...
  \param _n (size_t): individuals of the _r populations found in \ref populations.
  \param _a (size_t): alleles of the _r populations found in \ref populations.
  \param _terminal (size_t): indication to print in terminal or not.
  \param _file (size_t): indication to print in file or not.
  \param _f (vector<double>): frequence of the _r populations found in \ref populations.
  \param _c (vector<string): codon of the _r populations found in \ref populations.
 */
...
/*!
  ...
  Finaly, prints the genetique code of each population \ref Simulation::print_alleles().
 */
	void run();
...
/*!
  Display of the genetic code of each population.
  Printing in \ref terminal with \ref Simulation::print_terminal_alleles and/or in \ref file with \ref Simulation::print_file_alleles.
 */
	void printAlleles();
