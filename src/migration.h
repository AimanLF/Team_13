...
/*! \class Migration
  This class inherits from Simulation, an extension is added, the individuals now migrate from their population to another. 
  The migration can be represented as a star, ring or complete network.
  Migration parameters:
  - \ref matrix: holds the rates i.e. the fraction of population i moving to population j at each generation.
 */
...
/*!
  ...
  Finaly, prints the genetic code of each population \ref Simulation::print_alleles().
 */			
	void run(); 
/*!
  Perform one step of migration.
 */
	void migrate();	
/*!
